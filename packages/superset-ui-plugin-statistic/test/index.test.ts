 ...
 * under the License.
 */
import { SupersetUiPluginStatisticChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-superset-ui-plugin-statistic', () => {
  it('exists', () => {
    expect(SupersetUiPluginStatisticChartPlugin).toBeDefined();
  });
});
