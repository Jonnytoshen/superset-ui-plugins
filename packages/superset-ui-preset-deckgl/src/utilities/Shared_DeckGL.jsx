...
export const mapboxStyle = {
  ...
  config: {
    ...
    choices: [
      ...
      ['/static/assets/tianditu/tianditu_vector.json', '天地图道路'],
      ['/static/assets/tianditu/tianditu_satellite.json', '天地图卫星影像'],
      ['/static/assets/tianditu/tianditu_terrain.json', '天地图地形'],
    ],
    default: '/static/assets/tianditu/tianditu_satellite.json',
