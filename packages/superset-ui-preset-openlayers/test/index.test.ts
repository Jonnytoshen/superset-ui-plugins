 ...
 * under the License.
 */
import { SspingmeSupersetUiPresetOpenlayersChartPlugin } from '../src';
 ...
 */
describe('@superset-ui/plugin-chart-@sspingme/superset-ui-preset-openlayers', () => {
  it('exists', () => {
    expect(SspingmeSupersetUiPresetOpenlayersChartPlugin).toBeDefined();
  });
});
